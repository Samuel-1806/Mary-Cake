...
(() => {
  ...
  bgTextureLoader.load('assets/bg-silk.jpg', (tex) => {
  ...
  const bgFragmentShader = `
    ...
    void main() {
      ...
      vec2 uvWarp = vUvLocal + N.xy * 0.05;
      ...
      clothColor = mix(clothColor, uGoldColor, (sheen * 0.16 + sheen2 * 0.08) * (1.0 - uMapLoaded * 0.5));
      clothColor += highlightTone * specular * (0.7 - uMapLoaded * 0.3);

      float bumpStrength = clamp(vBump, 0.0, 1.0);
      clothColor = mix(clothColor, highlightTone, bumpStrength * (0.6 - uMapLoaded * 0.25));
