...
(() => {
  ...
  (function setupTelasShowcase() {
    ...
    dots.forEach((dot) => {
      dot.addEventListener('click', () => setActiveScreen(dot.dataset.dot));
    });
  ...
  tl.to('#hero-logo-solid', { opacity: 0, scale: 0.9, duration: 0.6, ease: 'power2.in' }, 0.3)
    ...
    .to(camera.position, { x: 0.15, y: 0.85, z: 2.6, duration: 1.6, ease: 'power2.inOut' }, 9.3)
    ...
    .to(camera.position, { x: 1.4, y: 0.1, z: 6.5, duration: 1.8, ease: 'power2.inOut' }, 11.1)
    ...
    .to(camera.position, { x: -0.3, y: 0.05, z: 7.4, duration: 1.8, ease: 'power2.inOut' }, 13.0)
    .to([phoneCenter.position, phoneLeft.position, phoneRight.position], { x: 0, y: 0, z: '-=2', duration: 1.8, ease: 'power2.in' }, 13.0)
    .to([phoneCenter.rotation, phoneLeft.rotation, phoneRight.rotation], { y: '+=3.2', duration: 1.8, ease: 'power2.in' }, 13.0)
