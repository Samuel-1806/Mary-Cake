...
(() => {
  ...
  function buildSmartphone(textureFile) {
    ...
    // pílula preta centralizada, colada no topo da tela. Usa
    // MeshBasicMaterial (não-iluminado) para nunca "brilhar" sob a luz
    // de estúdio — um notch real nunca reflete, só absorve luz.
    const notchWidth = bodyWidth * 0.34;
    const notchHeight = 0.1;
    ...
    notch.position.set(0, bodyHeight / 2 - 0.26, bodyFrontZ + 0.014);
