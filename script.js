...
(() => {
  ...
  function buildSmartphone(textureFile) {
    ...
    // ligeiramente à frente da placa pra dar sensação de relevo/profundidade.
    ...
    flash.position.set(lensOffset, -lensOffset, 0.002);
    camModule.add(flash);

    camModule.position.set(-bodyWidth / 2 + 0.34, bodyHeight / 2 - 0.46, -bodyDepth / 2 - 0.001);
